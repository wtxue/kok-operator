...
var CRDs = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 11, 18, 2, 52, 44, 488160172, time.UTC),
		},
		"/devops.k8s.io_clustercredentials.yaml": &vfsgen۰CompressedFileInfo{
			name:             "devops.k8s.io_clustercredentials.yaml",
			modTime:          time.Date(2020, 11, 24, 2, 10, 35, 565359833, time.UTC),
		...
		"/devops.k8s.io_clusters.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 24, 2, 10, 35, 616065503, time.UTC),
		...
		"/devops.k8s.io_machines.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 24, 2, 10, 35, 618074708, time.UTC),
